<?php
$moduleInput = rex_get_file_contents($REX["INCLUDE_PATH"] . "/addons/ckeditor/module/lite/input.php");
$moduleOutput = rex_get_file_contents($REX["INCLUDE_PATH"] . "/addons/ckeditor/module/lite/output.php");

// Ist Modul schon vorhanden ?
$searchtext = 'module: ckeditor_lite_in';
...
if (isset($_REQUEST["install"]) && $_REQUEST["install"] == 1) {
  $module_name = $I18N->msg('ckeditor_module_name_lite');
...
<p><?php echo $I18N->msg('ckeditor_module_lite_desc'); ?></p>
<p>
<?php
	if ($module_id > 0) {
		if (!isset($_REQUEST["install"])) {
			echo '<a id="update-module" href="index.php?page=ckeditor&amp;subpage=modules&amp;install=1&amp;module_id=' . $module_id . '">&gt;&gt; ' . $I18N->msg('ckeditor_module_update') . '</a>';
		}
	} else {
		if (!isset($_REQUEST["install"])) {
			echo '<a href="index.php?page=ckeditor&amp;subpage=modules&amp;install=1">&gt;&gt; ' . $I18N->msg('ckeditor_module_install') . '</a>';
		}
	}
?>		
</p>
